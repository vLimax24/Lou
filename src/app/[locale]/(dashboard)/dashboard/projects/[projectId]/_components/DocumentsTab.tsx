...
const DocumentsTab = ({ project }: { project: any }) => {
  ...
  return (
    <div className="mx-4 mt-4 flex flex-col lg:mx-0">
      <div className="flex">
        ...
        <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
          ...
          <DialogContent className="sm:max-w-[425px]">
            <DialogHeader>
              ...
              <DialogDescription>
                Link an existing document to your project.
              </DialogDescription>
            </DialogHeader>
            <div>
              {documents?.length === 0 ? (
        ...
        {documents?.length === 0 ? (
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
            {documents?.map((document: any) => (
              ...
              >
                <Card className="flex w-full items-center justify-between px-3 py-4 md:w-[400px]">
                  <p>{document.name}</p>
                </Card>
              </Link>
            ))}
